namespace Ovning17.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<ApplicationDbContext>
    {
        ...
        protected override void Seed(ApplicationDbContext context)
        {
            ...
            var emails = new string[] { "admin@lexicon.se" };
            ...
            //var editorUser = userManager.FindByName("churail@lexicon.se");
            //userManager.AddToRole(editorUser.Id, "Churail"); //Roles.Editor
